...
public:
	...
	static thread_local std::vector<std::string> INPUT_NAME;///< input name inside the model.
	...
	static thread_local std::string DET_SCORE;
	static thread_local std::string DET_CLASS_ID;
	static thread_local std::string DET_COORD;
	static thread_local std::string DET_NUM_BBOX;
private:
	static bool init;
};
}